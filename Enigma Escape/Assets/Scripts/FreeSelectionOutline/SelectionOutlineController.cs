...
public class SelectionOutlineController : MonoBehaviour
{
    ...
    void Update()
    {
            ...
            if (Physics.Raycast(ray, out hit))
            {
                ...
                if(hit.transform.CompareTag("LlaveArmario") || hit.transform.CompareTag("Provincias") || hit.transform.CompareTag("Llave") 
                    || hit.transform.CompareTag("OvaloEscudoNacional") || hit.transform.CompareTag("PicaEscudoNacional")
                    || hit.transform.CompareTag("GorroEscudoNacional") || hit.transform.CompareTag("ManosEscudoNacional") || hit.transform.CompareTag("LaurelesEscudoNacional")
                    || hit.transform.CompareTag("SolEscudoNacional") || hit.transform.CompareTag("Mate") || hit.transform.CompareTag("LlaveDormitorio")
                    || hit.transform.CompareTag("PuertaDormitorio") || hit.transform.CompareTag("PuertaArmario2") || hit.transform.CompareTag("CuadroCataratas")
                    || hit.transform.CompareTag("Cajones") || hit.transform.CompareTag("CajonConLlave") || hit.transform.CompareTag("CuadroMapaArg")
                    || hit.transform.CompareTag("BotonGlaciar") || hit.transform.CompareTag("BotonPalmar") || hit.transform.CompareTag("BotonCerro")
                    || hit.transform.CompareTag("BotonPinguino") || hit.transform.CompareTag("BotonCarpincho") || hit.transform.CompareTag("BotonLlama")
                    || hit.transform.CompareTag("TV") || hit.transform.CompareTag("Guitarra") || hit.transform.CompareTag("Pilas") || hit.transform.CompareTag("Radio_Con")
                    || hit.transform.CompareTag("Piano") || hit.transform.CompareTag("Panel") || hit.transform.CompareTag("Panel2") || hit.transform.CompareTag("Manija")
                    || hit.transform.CompareTag("Copa") || hit.transform.CompareTag("PuertaEntrada") || hit.transform.CompareTag("PuertaDeSalida") || hit.transform.CompareTag("PuertaSala")
                    || hit.transform.CompareTag("Pista1") || hit.transform.CompareTag("Pista2") || hit.transform.CompareTag("Pista3") || hit.transform.CompareTag("BotonMesa"))
                    {
